...
| **Independent review evidence** | ≥ 1 per task group | `.architect-team/reviews/<task-id>.json`, `independent_review.reviewer != teammate` per v7, bound via `task_subject` (ids reused; `<id>.<slug>.json` on clash) |
