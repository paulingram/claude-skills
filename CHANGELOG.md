...
PRE-EXISTING RED, not introduced here: 5 failures in `tests/test_report_claims_citation.py` were already present on this branch's merge base (the v3.47.x evidence-integrity work) and are untouched by this release.
