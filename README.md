...
![version](https://img.shields.io/badge/version-0.9.25-2563EB?style=flat-square)
![license](https://img.shields.io/badge/license-MIT-3FB950?style=flat-square)
![tests](https://img.shields.io/badge/tests-876%20passing-3FB950?style=flat-square)
...
```
   ...
   ◆       v0.9.25 ─ bug-fix-pipeline gets its own planning-validation gate at Phase B3 (current)
