...
![version](https://img.shields.io/badge/version-3.55.3-2563EB?style=flat-square)
![license](https://img.shields.io/badge/license-MIT-3FB950?style=flat-square)
![tests](https://img.shields.io/badge/tests-7022%20passing-3FB950?style=flat-square)
...
HONEST BOUNDARY: this release sweeps the defect class and RECORDS the review — it does NOT build the multi-bug orchestration (E1–E5); that build is QUEUED as a fresh, focused `/architect-team` run per the user's decision. Every earlier release remains in full at [`docs/RELEASE_HISTORY.md`](docs/RELEASE_HISTORY.md).
...
```
   ...
   ◆       v3.55.3 ─ debug-3cycle-fix — the bounded-at-3-cycles loop-cap
           anti-pattern swept from every agent body (diagnostic-researcher,
           system-architect ×2, oracle-deriver — each contradicted its own
           skill's unbounded loop; a repo-wide pin forbids re-introduction);
           the debugging-skill review recorded as a proposal doc, the
           multi-bug orchestration build queued as a fresh /architect-team run
