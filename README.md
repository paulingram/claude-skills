...
![tests](https://img.shields.io/badge/tests-7215%20passing-3FB950?style=flat-square)
...
| **Counts + tests** | MINOR — additive within `hooks/`; no new skill / agent / command / hook script / Layer-3 tool; inventory unchanged (53 / 39 / 25 / 7 / 22). Suite **7024 → 7215 passing + 6 skipped, 0 failed** (+191 tests; 241 top-level test files, both encodings). |
