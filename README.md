...
![version](https://img.shields.io/badge/version-0.9.34-2563EB?style=flat-square)
![license](https://img.shields.io/badge/license-MIT-3FB950?style=flat-square)
![tests](https://img.shields.io/badge/tests-1262%20passing-3FB950?style=flat-square)
...
```
   ...
   ◆       v0.9.34 ─ email-testing — automatic Mailpit-based email flow verification across all QA agents (current)
