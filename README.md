...
![version](https://img.shields.io/badge/version-0.9.24-2563EB?style=flat-square)
![license](https://img.shields.io/badge/license-MIT-3FB950?style=flat-square)
![tests](https://img.shields.io/badge/tests-861%20passing-3FB950?style=flat-square)
...
```
   ...
   ◆       v0.9.24 ─ MemPalace wake-up runs at the earliest phase, before any subagent dispatch (current)
