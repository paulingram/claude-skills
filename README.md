...
![version](https://img.shields.io/badge/version-0.9.31-2563EB?style=flat-square)
![license](https://img.shields.io/badge/license-MIT-3FB950?style=flat-square)
![tests](https://img.shields.io/badge/tests-1028%20passing-3FB950?style=flat-square)
...
```
   ...
   ◆       v0.9.31 ─ Phase B6 code-path execution witness — qa-replayer catches tests that pass via wrong path (current)
