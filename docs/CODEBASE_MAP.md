...
```
claude_skill_lib/
├── .claude-plugin/          # Plugin identity: plugin.json + marketplace.json (v0.9.15)
...
├── tests/                   # 418 pytest self-tests (~24 test files + conftest + helpers/)
